<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Site1.Master" AutoEventWireup="true" CodeBehind="checkout.aspx.cs" Inherits="GroupProject.Customer.checkout" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <asp:Button ID="Button1" class="site-btn" runat="server" Text="PLACE ORDER" OnClick="Button1_Click" />                               
                            </div>
                        </div>
                    </div>
                </form>
